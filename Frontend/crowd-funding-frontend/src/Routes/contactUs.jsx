      ...
      <div className="row col-12">
        <div className={`col-md-8 ${styles.contactUs}`}>
          ...
          <p className={styles.content}>
            ...
            consequatur ea quia inventore excepturi officiis deserunt sequi,
            esse nobis laudantium tempora aut, animi praesentium id!
            Necessitatibus laborum vitae vero at!
          </p>
        </div>
        <div className={`col-md-4 ${styles.details}`}>
          <h1 className={styles.header}>Our Office</h1>
          <p className={styles.content}>
            <b>ROTORACT IIITM</b>
            <br />
            IIITM Campus,
